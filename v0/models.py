...
class Images(models.Model):
    ...
    origin_name = models.CharField(max_length=30, default='origin_name') # 有格式后缀的图片名
    name = models.CharField(max_length=30) # 无格式后缀的图片名，当有重复`origin_name`存在时，为`name`加 _2、_3这样的扩展名
