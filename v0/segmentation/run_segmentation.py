...
from .dataset.dataset_revision import OralSlideSeg
...
class Segmentation():
    def __init__(self, config, slide_list):
    ...
    def run_segmentation(self, slide_name, samples_pil, samples):
        self.f_log = open(self.log_path + "test.log", 'a+')
        ...
        self.dataset.get_patches_from_index(find_index, samples_pil, samples)
