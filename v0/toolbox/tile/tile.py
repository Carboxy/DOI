...
class Cutter(object):
    def __init__(self, 
        ...
        self.slide_object_list = slide_object_list
    ...
    def sample_and_store_patches_png(self,
        ...
        for i, file in tqdm(enumerate(self.files)):
            print(file, end="  k ")
            #image_object = self.slide_object_list[i]
            #file_info, patches_num, target_info_slide = sample_store_patches_png(file,
            file_info, patches_num, samples_pil, samples = sample_store_patches_png(file,
                                                            #self.file_dir,
                                                            self.slide_object_list[i],  
                                                            #self.file_mask_dir,
                                                            #self.save_patch_dir,
                                                            patch_size,
                                                            overlap,
        ...
        print("")
        end_timer(start_time) 
        return file_info, samples_pil, samples
